...
class PEMIRL_AIRL(torch.nn.Module):
    ...
    def airl_reward(self, s, a):
        ...
        reward = d # this is much better than using log(d), i.e., the original design
        # print("here: ", reward)
        ...
        for _ in range(n_step):
            ...
            for ind_p in inds.split(self.mini_bs):
                ...
                for _ in range(1):
                    ...
                    clip_grad_norm_(self.discriminator.parameters(), max_norm=20, norm_type=2) # necessary to avoid the program to collide
                    # for p in self.discriminator.parameters():
