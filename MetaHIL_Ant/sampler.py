...
class _SamplerSS(_SamplerCommon):
    def __init__(self, seed, env, policy, loop_func=None, repeat_loop_func=None, is_expert=False, repeat_num=-1, task_list=None):
...
def Sampler(seed, env, policy, is_expert, repeat_num=-1, task_list=None) -> _SamplerCommon:
    ...
    class_m = _SamplerSS
    return class_m(seed, env, policy, loop_func, repeat_loop_func, is_expert, repeat_num, task_list)
