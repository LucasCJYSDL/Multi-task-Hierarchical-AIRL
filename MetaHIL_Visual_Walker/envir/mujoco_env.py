...
def collect_demo(config, n_task=1000, demo_per_task=10, data_type='train',
    ...
    if not is_manual:
        ...
        policy = Policy(config, dim_s-1, dim_a)
    ...
    if os.path.isfile(path):
        ...
        for task_idx in samples:
            ...
            for traj in temp_list:
                s, c, a, r = traj
                print(s.shape, c.shape, a.shape, r.shape, r.sum())
...
if __name__ == '__main__':
    ...
    # collect_demo(config, n_task=100, demo_per_task=10, data_type='train', expert_path='./exp_model/WalkerRandParams/19749.torch')
    # collect_demo(config, n_task=50, demo_per_task=10, data_type='test', expert_path='./exp_model/WalkerRandParams/19749.torch')

    get_demo_stat('WalkerRandParams-v0_sample_train.torch')
    get_demo_stat('WalkerRandParams-v0_sample_test.torch')
