...
if __name__ == '__main__':
    ...
    if arg.algo == "SMILE":
        arg.env_name = "KitchenMetaEnv-v1"
    # the update rule of the context network for SMILE restricts that its context network output cannot be discrete,
    # so we have to modify the env setting
