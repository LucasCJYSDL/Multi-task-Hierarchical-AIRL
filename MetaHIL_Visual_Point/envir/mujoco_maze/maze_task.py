...
class MultiGoalRewardCell_2(MultiGoalRewardCell):
    ...
    def create_maze(self) -> List[List[MazeCell]]:
        ...
        return [
            [B, B, B, B, B, B, B, B, B, B, B, B, B, B, B],
            [B, B, B, B, B, B, B, B, B, B, B, B, B, B, B],
            [B, B, E, E, E, E, E, E, E, E, E, E, E, B, B],
            [B, B, E, E, B, B, B, E, B, B, B, E, E, B, B],
            [B, B, E, E, B, B, B, E, B, B, B, E, E, B, B],
            [B, B, E, E, B, B, B, E, B, B, B, E, E, B, B],
            [B, B, E, E, B, B, B, E, B, B, B, E, E, B, B],
            [B, B, E, E, E, E, E, R, E, E, E, E, E, B, B],
            [B, B, E, E, B, B, B, E, B, B, B, E, E, B, B],
            [B, B, E, E, B, B, B, E, B, B, B, E, E, B, B],
            [B, B, E, E, B, B, B, E, B, B, B, E, E, B, B],
            [B, B, E, E, B, B, B, E, B, B, B, E, E, B, B],
...
class TaskRegistry:
    REGISTRY: Dict[str, List[Type[MazeTask]]] = {
        "Cell": [DistRewardCell, MultiGoalRewardCell, MultiGoalRewardCell_2]
    }
