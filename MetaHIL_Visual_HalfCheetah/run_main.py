...
def learn(config: Config, msg="default"):
    ...
    # print("000:", -len(test_contexts))
    info_dict, cs_sample = reward_validate(sampling_agent, il.policy, training_episode=0, time_token=time_token,
                                           n_sample=-len(test_contexts), do_print=True)
    ...
    for i in range(n_epoch):
        ...
        if (i + 1) % config.log_interval == 0:
            ...
            info_dict, cs_sample = reward_validate(sampling_agent, il.policy, training_episode=i, time_token=time_token,
                                           n_sample=-len(test_contexts), do_print=True)
