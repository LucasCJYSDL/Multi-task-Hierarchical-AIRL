...
def plot():
    ...
    file_dir = {'MH-AIRL': [13373, 13520, 14923], 'Option-GAIL': [30688, 30845, 30890, 31010, 31141],
                'DI-GAIL': [31472, 31518, 31592, 31685, 31750], 'H-AIRL': [33219, 33307, 33394, 33475, 33618],
                'MH-GAIL': [33971, 34039, 34213, 34288]}
